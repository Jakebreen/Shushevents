...
public final class UpdateEventPresenterImpl extends BasePresenterImpl<UpdateEventView> implements UpdateEventPresenter {
    /**
     * The interactor
     */
    @NonNull
    private final UpdateEventInteractor mInteractor;

    // The view is available using the mView variable

    @Inject
    public UpdateEventPresenterImpl(@NonNull UpdateEventInteractor interactor) {
