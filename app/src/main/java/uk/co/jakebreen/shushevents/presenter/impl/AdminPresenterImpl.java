...
public final class AdminPresenterImpl extends BasePresenterImpl<AdminView> implements AdminPresenter {
    /**
     * The interactor
     */
    @NonNull
    private final AdminInteractor mInteractor;

    // The view is available using the mView variable

    @Inject
    public AdminPresenterImpl(@NonNull AdminInteractor interactor) {
